  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>list semua recommended produk</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin/home"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url();?>admin/product/">Product</a></li>
        <li class="active"><a href="<?php echo base_url();?>admin/product/list_recommended_product">Recommended Product</a></li>
      </ol>
    </section>
          ...
          <div class="table-responsive box">
            ...
            <div class="box-body">
				<table id="example1" class="text-center table table-bordered table-hover">
					...
					<?php
						$i=1;
						foreach($list_recommended_produk as $produk)
						{
					?>
							<tr>
								<td><?php echo $i;?></td>
