 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Delete Images Product Form
        <small>Form Menghapus Gambar Produk</small>
      </h1>
      <ol class="breadcrumb">
			...
			<div class="box">
				...
				<div class="box-body">
					<?php 
						...
						echo form_open("admin/product/delete_image_produk_action/", "role='form' enctype='multipart/form-data'"); 
					?> 
					...
					<div class="col-md-4">
						...
						<div class="form-group">
						  ...
						  <select disabled class="form-control" name="image_status">
