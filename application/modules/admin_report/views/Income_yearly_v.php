 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Income Reports
        <small>Yearly Income Reports</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin/home"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="<?php echo base_url();?>admin/report/yearly">Yearly</a></li>
      </ol>
    </section>
			...
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-green">
					<div class="inner">
						<h3>
							<?php 
								$nincome_yearly = number_format($stat["nincome_yearly"]);
								$nincome_yearly = str_replace(",", ".",$nincome_yearly);
								echo "Rp ".$nincome_yearly.",-";
							?>
						</h3>
          ...
          <div class="table-responsive box">
            ...
            <div class="box-body">
				<table id="example1" class="text-center table table-bordered table-hover">
					...
					<?php
						$i=1;
						$array_data = $income_yearly;
						foreach($income_yearly as $income)
						{
					...
					?>
							<tr>
								<td><?php echo $i;?></td>
								<td><?php echo $income->tahun_pesanan; ?></td>
								...
								<td>
									<a href="<?php echo site_url('admin/report/detail_yearly_report/'.base64_encode($income->tahun_pesanan)); ?>" target="_blank"><i class="fa fa-edit fa-2x"></i> View</a>
								</td>
							</tr>
					<?php
							$i++;
						}
						$income_yearly = $array_data;
						
						$limit=0;
						$year = "";
						$income = "";
						foreach($income_yearly as $data)
						{
							if ($limit==9 or $data === end($income_yearly))
							{
								$year = $year.'"'.$data->tahun_pesanan.'"';
