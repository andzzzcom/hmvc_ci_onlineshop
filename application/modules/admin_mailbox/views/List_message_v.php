 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Message Inbox Customer
        <small>list semua pesan Inbox Customer</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin/home"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="<?php echo base_url();?>admin/mailbox/">Mailbox</a></li>
      </ol>
    </section>
            ...
            <div class="box-body">
				<table id="example1" class="text-center table table-bordered table-hover">
					...
					?>
							<tr>
								<td><?php echo $i;?></td>
								<td><a href="<?php echo base_url();?>admin/user/edit_user/<?php echo $mailbox->id_customer; ?>" target="_blank"><?php echo $mailbox->email_user; ?></a></td>
								<td><a href="<?php echo base_url();?>admin/mailbox/detail_message/<?php echo $mailbox->id_message; ?>" target="_blank"><?php echo $mailbox->title_message; ?></a></td>
