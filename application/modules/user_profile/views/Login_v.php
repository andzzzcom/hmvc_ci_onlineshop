  ...
  <section class="main-container col1-layout" style="background-color:white">
    <div class="main container">
        ...
        <div class="page-content">
			...
			<form method="post" onsubmit="return validasi();" action="<?php echo base_url();?>login_action">
				<div class="box-authentication">
					...
					<p class="forgot-pass"><a href="<?php echo base_url();?>forgot_password">Lost your password?</a></p>
				</div>
			</form>
