						...
						<table class="table table-border text-center">
							...
							?>
								<tr style="color:black;height:50px;">
									...
									<td><a class="btn btn-default" href="<?php echo base_url();?>profile/detail_message/<?php echo $message->id_message; ?>" target="_blank">View</a></td>
								</tr>
							<?php
									$i++;
								}
