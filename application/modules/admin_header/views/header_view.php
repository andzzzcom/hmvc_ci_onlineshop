      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
				...
				?>
					  <li>
						<div class="pull-left" style="padding:10px"><img src="<?php echo base_url();?>assets/images/favicon/envelope.ico" width="30px" height="30px"></div>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/images/admin/<?php echo $fotoadmin;?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $namaadmin; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets/images/admin/<?php echo $fotoadmin;?>" class="img-circle" alt="User Image">
